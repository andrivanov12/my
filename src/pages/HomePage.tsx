...
const HomePage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>ЧатGPT без регистрации - Общайтесь с ИИ легко и быстро</title>
        <meta name="description" content="Используйте ЧатGPT без регистрации! Получите мгновенные ответы на ваши вопросы, общайтесь с искусственным интеллектом и наслаждайтесь удобством общения. Попробуйте прямо сейчас!" />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <section className="max-w-4xl mx-auto mb-12 md:mb-16 px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-6 md:mb-8">
            Как использовать ЧатGPT без регистрации
          </h2>
        ...
        <section className="max-w-4xl mx-auto text-center px-4 mt-12 md:mt-16">
          ...
          <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 mb-6 md:mb-8">
            Нажмите кнопку ниже и начните общение с ЧатGPT прямо сейчас!
          </p>
