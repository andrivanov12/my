...
const AiPromptOptimizerPage: React.FC = () => {
  ...
  return (
    <>
      <SEOTags
        title="Генерация маркетингового контента с ИИ | Оптимизация промптов для нейросетей"
        description="Создавайте высококачественный маркетинговый контент с помощью искусственного интеллекта. Оптимизируйте промпты для генерации текстов для сайта, блога, социальных сетей, email-рассылок и рекламы."
        keywords="генерация маркетингового контента, нейросети для копирайтинга, AI для создания текстов, оптимизация промптов для маркетинга, контент-маркетинг с ИИ, автоматизация копирайтинга, искусственный интеллект для маркетологов, генерация SEO-текстов, нейросети для email-маркетинга, AI для социальных сетей"
      ...
      <div className="container mx-auto px-4 py-8 md:py-12 max-w-6xl">
        ...
        <section className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-primary-600 to-secondary-500 bg-clip-text text-transparent">
            Генерация маркетингового контента с искусственным интеллектом
          </h1>
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed max-w-4xl mx-auto mb-8">
            Создавайте высококачественный маркетинговый контент для всех каналов с помощью искусственного интеллекта. 
            Наш инструмент оптимизирует промпты для генерации текстов, которые привлекают, вовлекают и конвертируют 
