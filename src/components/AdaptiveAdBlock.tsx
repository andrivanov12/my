...
interface AdaptiveAdBlockProps {
  blockId: string;
  containerId: string;
  position: 'top' | 'bottom' | 'sidebar' | 'main-banner' | 'bottom-banner' | 'chat-top' | 'chat-bottom' | 'prompt-optimizer-top' | 'prompt-optimizer-bottom' | 'n8n-optimizer-top' | 'n8n-optimizer-bottom';
  className?: string;
}
...
const AdaptiveAdBlock: React.FC<AdaptiveAdBlockProps> = ({ 
  ...
  useEffect(() => {
    ...
    // Инициализируем Яндекс.РТБ для блоков R-A-16048264-1, R-A-16048264-2, R-A-16048264-3, R-A-16048264-4, R-A-16048264-5, R-A-16048264-6, R-A-16048264-7, R-A-16048264-8 и R-A-16048264-9
    if (blockId === 'R-A-16048264-1' || blockId === 'R-A-16048264-2' || blockId === 'R-A-16048264-3' || blockId === 'R-A-16048264-4' || blockId === 'R-A-16048264-5' || blockId === 'R-A-16048264-6' || blockId === 'R-A-16048264-7' || blockId === 'R-A-16048264-8' || blockId === 'R-A-16048264-9') {
  ...
  // Показываем только блоки R-A-16048264-1, R-A-16048264-2, R-A-16048264-3, R-A-16048264-4, R-A-16048264-5, R-A-16048264-6, R-A-16048264-7, R-A-16048264-8 и R-A-16048264-9
  if (blockId !== 'R-A-16048264-1' && blockId !== 'R-A-16048264-2' && blockId !== 'R-A-16048264-3' && blockId !== 'R-A-16048264-4' && blockId !== 'R-A-16048264-5' && blockId !== 'R-A-16048264-6' && blockId !== 'R-A-16048264-7' && blockId !== 'R-A-16048264-8' && blockId !== 'R-A-16048264-9') {
    return null;
  }
...
const getAdDimensions = (position: string, isMobile: boolean) => {
  const dimensions = {
    ...
    'prompt-optimizer-top': isMobile 
      ? { maxWidth: '320px', height: '100px', margin: '0 auto' }
      : { maxWidth: '1000px', height: '120px', margin: '0 auto' },
    'prompt-optimizer-bottom': isMobile 
      ? { maxWidth: '320px', height: '100px', margin: '0 auto' }
      : { maxWidth: '1000px', height: '120px', margin: '0 auto' },
    'n8n-optimizer-top': isMobile 
      ? { maxWidth: '320px', height: '100px', margin: '0 auto' }
      : { maxWidth: '1000px', height: '120px', margin: '0 auto' },
    'n8n-optimizer-bottom': isMobile 
      ? { maxWidth: '320px', height: '100px', margin: '0 auto' }
      : { maxWidth: '1000px', height: '120px', margin: '0 auto' },
    top: isMobile 
      ? { maxWidth: '320px', height: '100px', margin: '0 auto' }
